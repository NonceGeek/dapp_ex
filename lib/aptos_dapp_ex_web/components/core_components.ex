defmodule AptosDappExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AptosDappExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AptosDappExWeb.Gettext, "errors", msg, opts)
    end
  end
